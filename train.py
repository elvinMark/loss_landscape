...
parser.add_argument("--lr",type=float,default=0.01,help="specify the base learning rate to be used during training")
parser.add_argument("--optim",type=str,default="sgd",help="specify the optimizer to be used in the training")
parser.add_argument("--sched",type=str,default="step",help="specify the scheduler to be used")
parser.add_argument("--step-size",type=int,default=10,help="specify the step size to be used in the step lr scheduler")
parser.add_argument("--gamma",type=float,default=0.2,help="specify the gamma factor used in the step lr scheduler")
parser.add_argument("--T_max",type=int,default=50,help="specify the T_max factor to be used in the cosine lr scheduler")
parser.add_argument("--eta_min",type=float,default=0.0,help="specify the eta_min factor to be used in the cosine lr scheduler")
parser.add_argument("--milestones",type=int,nargs="+",default=[20,40],help="specify the milestones to be used in the multistep lr scheduler")
